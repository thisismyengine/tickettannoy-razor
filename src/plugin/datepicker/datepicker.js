...
(function(global, factory) {
	...
	var DEFAULTS = {
		...
		highlightedClass: 'today',
		// The template of the datepicker
		template: '<div class="datepicker"><div class="current" data-view="month current"></div><div data-view="days picker"><div class="row" data-view="week"></div><div class="view" data-view="days"></div><div class="control"><a class="prev" data-view="month prev"></a><a class="next" data-view="month next"></a></div></div></div>',
		...
		function() {
			...
			_createClass(Datepicker, [{
				...
				value: function place() {
					...
					$picker.removeClass(CLASS_PLACEMENTS).css({
						top: top,
						left: left
					});
